...
class Qest21L1Handler(L1HandlerBase):
    ...
    def __init__(self, logger):
        ...
        try:
            with open(os.path.join(os.path.dirname(sys.argv[0]), 'qest21_runtime_configuration.json')) as f:
                o = json.loads(f.read())
    ...
    def get_resource_description(self, address):
        ...
        BLADE_MODEL = 'Qest21 Blade'
        PORT_PREFIX = 'port'
        PORT_FAMILY = 'L1 Switch Port'
        PORT_MODEL = 'Qest21 Port'
