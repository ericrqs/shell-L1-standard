...
#
# This file will be the entry point of Qest21.exe
#
# It will be invoked by CloudShell as Qest21.exe <listening port number>

from cloudshell.core.logger.qs_logger import get_qs_logger
from l1_driver import L1Driver
from qest21_l1_handler import Qest21L1Handler
import os
import sys
...
logger = get_qs_logger(log_group='Qest21',
                       log_file_prefix='Qest21',
                       log_category='INTERNAL')


# Instantiate your implementation of L1HandlerBase
handler = Qest21L1Handler(logger=logger)
