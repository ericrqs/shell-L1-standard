...
# from zlitest5_tl1_connection import Zlitest5TL1Connection
# from zlitest5_cli_connection import Zlitest5CliConnection, Zlitest5DefaultCommandMode, Zlitest5EnableCommandMode, Zlitest5ConfigCommandMode

class Zlitest5L1Handler(L1HandlerBase):
    ...
    def __init__(self, logger):
        ...
        try:
            with open(os.path.join(os.path.dirname(sys.argv[0]), 'zlitest5_runtime_configuration.json')) as f:
                o = json.loads(f.read())
        ...
        # Zlitest5DefaultCommandMode.PROMPT_REGEX = o.get("common_variable", {}).get("default_prompt", r'>\s*$')
        # Zlitest5EnableCommandMode.PROMPT_REGEX = o.get("common_variable", {}).get("enable_prompt", r'#\s*$')
        # Zlitest5ConfigCommandMode.PROMPT_REGEX = o.get("common_variable", {}).get("config_prompt", r'[(]config.*[)]#\s*$')
    ...
    def login(self, address, username, password):
        ...
        # self._tl1_connection = Zlitest5TL1Connection(self._logger, self._host, self._port, self._username, self._password)
        # self._cli_connection = Zlitest5CliConnection(self._logger, 'ssh', self._host, self._port, self._username, self._password)
    ...
    def get_resource_description(self, address):
        ...
        SWITCH_MODEL = 'Zlitest5'
        BLADE_PREFIX = 'module'
        BLADE_FAMILY = 'L1 Switch Blade'
        BLADE_MODEL = 'Zlitest5 Blade'
        PORT_PREFIX = 'port'
        PORT_FAMILY = 'L1 Switch Port'
        PORT_MODEL = 'Zlitest5 Port'
