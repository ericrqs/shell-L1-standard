...
class Zlitest5DefaultCommandMode(CommandMode):
    PROMPT_REGEX = r'>\s*$'
    ENTER_COMMAND = ''
    EXIT_COMMAND = 'exit'
    def __init__(self):
        CommandMode.__init__(self,
                             Zlitest5DefaultCommandMode.PROMPT_REGEX,
                             Zlitest5DefaultCommandMode.ENTER_COMMAND,
                             Zlitest5DefaultCommandMode.EXIT_COMMAND)


class Zlitest5EnableCommandMode(CommandMode):
    PROMPT_REGEX = r'#\s*$'
    ENTER_COMMAND = ''
    EXIT_COMMAND = 'exit'
    def __init__(self):
        CommandMode.__init__(self,
                             Zlitest5EnableCommandMode.PROMPT_REGEX,
                             Zlitest5EnableCommandMode.ENTER_COMMAND,
                             Zlitest5EnableCommandMode.EXIT_COMMAND)


class Zlitest5ConfigCommandMode(CommandMode):
    PROMPT_REGEX = r'[(]config.*[)]#\s*$'
    ENTER_COMMAND = ''
    EXIT_COMMAND = 'exit'
    def __init__(self):
        CommandMode.__init__(self,
                             Zlitest5ConfigCommandMode.PROMPT_REGEX,
                             Zlitest5ConfigCommandMode.ENTER_COMMAND,
                             Zlitest5ConfigCommandMode.EXIT_COMMAND)


CommandMode.RELATIONS_DICT = {
    Zlitest5DefaultCommandMode: {
        Zlitest5EnableCommandMode: {
            Zlitest5ConfigCommandMode: {
            }
        }
    }
}
...
class _Zlitest5CliHandler(CliHandlerImpl):

    def __init__(self, cli, logger, cli_type, host, port, username, password):
        super(_Zlitest5CliHandler, self).__init__(cli, None, logger, None)
        ...
        self.default_mode = modes[Zlitest5DefaultCommandMode]
        self.enable_mode = modes[Zlitest5EnableCommandMode]
        self.config_mode = modes[Zlitest5ConfigCommandMode]
    ...
    def on_session_start(self, session, logger):
        super(_Zlitest5CliHandler, self).on_session_start(session, logger)
...
class Zlitest5CliConnection:
    def __init__(self, logger, cli_type, host, port, username, password, session_pool_size=1):
        ...
        self._cli_handler = _Zlitest5CliHandler(self._cli, logger, cli_type, host, port, username, password)
