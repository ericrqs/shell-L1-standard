...
class Zlitest4DefaultCommandMode(CommandMode):
    PROMPT_REGEX = r'>\s*$'
    ENTER_COMMAND = ''
    EXIT_COMMAND = 'exit'
    def __init__(self):
        CommandMode.__init__(self,
                             Zlitest4DefaultCommandMode.PROMPT_REGEX,
                             Zlitest4DefaultCommandMode.ENTER_COMMAND,
                             Zlitest4DefaultCommandMode.EXIT_COMMAND)


class Zlitest4EnableCommandMode(CommandMode):
    PROMPT_REGEX = r'#\s*$'
    ENTER_COMMAND = ''
    EXIT_COMMAND = 'exit'
    def __init__(self):
        CommandMode.__init__(self,
                             Zlitest4EnableCommandMode.PROMPT_REGEX,
                             Zlitest4EnableCommandMode.ENTER_COMMAND,
                             Zlitest4EnableCommandMode.EXIT_COMMAND)


class Zlitest4ConfigCommandMode(CommandMode):
    PROMPT_REGEX = r'[(]config.*[)]#\s*$'
    ENTER_COMMAND = ''
    EXIT_COMMAND = 'exit'
    def __init__(self):
        CommandMode.__init__(self,
                             Zlitest4ConfigCommandMode.PROMPT_REGEX,
                             Zlitest4ConfigCommandMode.ENTER_COMMAND,
                             Zlitest4ConfigCommandMode.EXIT_COMMAND)


CommandMode.RELATIONS_DICT = {
    Zlitest4DefaultCommandMode: {
        Zlitest4EnableCommandMode: {
            Zlitest4ConfigCommandMode: {
            }
        }
    }
}
...
class _Zlitest4CliHandler(CliHandlerImpl):

    def __init__(self, cli, logger, cli_type, host, port, username, password):
        super(_Zlitest4CliHandler, self).__init__(cli, None, logger, None)
        ...
        self.default_mode = modes[Zlitest4DefaultCommandMode]
        self.enable_mode = modes[Zlitest4EnableCommandMode]
        self.config_mode = modes[Zlitest4ConfigCommandMode]
    ...
    def on_session_start(self, session, logger):
        super(_Zlitest4CliHandler, self).on_session_start(session, logger)
...
class Zlitest4CliConnection:
    def __init__(self, logger, cli_type, host, port, username, password, session_pool_size=1):
        ...
        self._cli_handler = _Zlitest4CliHandler(self._cli, logger, cli_type, host, port, username, password)
