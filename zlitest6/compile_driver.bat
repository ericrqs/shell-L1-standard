...
copy dist\Zlitest6.exe                     %driverdir%
copy zlitest6_runtime_configuration.json %driverdir%



copy zlitest6_datamodel.xml               release\
copy dist\Zlitest6.exe                      release\
copy zlitest6_runtime_configuration.json  release\
