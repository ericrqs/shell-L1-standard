...
class L1SSHTestDefaultCommandMode(CommandMode):
    PROMPT_REGEX = r'>\s*$'
    ENTER_COMMAND = ''
    EXIT_COMMAND = 'exit'
    ...
    def __init__(self):
        CommandMode.__init__(self,
                             L1SSHTestDefaultCommandMode.PROMPT_REGEX,
                             L1SSHTestDefaultCommandMode.ENTER_COMMAND,
                             L1SSHTestDefaultCommandMode.EXIT_COMMAND)


class L1SSHTestEnableCommandMode(CommandMode):
    PROMPT_REGEX = r'#\s*$'
    ...
    def __init__(self):
        CommandMode.__init__(self,
                             L1SSHTestEnableCommandMode.PROMPT_REGEX,
                             L1SSHTestEnableCommandMode.ENTER_COMMAND,
                             L1SSHTestEnableCommandMode.EXIT_COMMAND)


class L1SSHTestConfigCommandMode(CommandMode):
    ...
    def __init__(self):
        CommandMode.__init__(self,
                             L1SSHTestConfigCommandMode.PROMPT_REGEX,
                             L1SSHTestConfigCommandMode.ENTER_COMMAND,
                             L1SSHTestConfigCommandMode.EXIT_COMMAND)


CommandMode.RELATIONS_DICT = {
    L1SSHTestDefaultCommandMode: {
        L1SSHTestEnableCommandMode: {
            L1SSHTestConfigCommandMode: {
            }
        }
    }
}
...
class _L1SSHTestCliHandler(CliHandlerImpl):
    def __init__(self, cli, logger):
        super(_L1SSHTestCliHandler, self).__init__(cli, None, logger, None)
        self._cli_type = None
        ...
        self.default_mode = modes[L1SSHTestDefaultCommandMode]
        self.enable_mode = modes[L1SSHTestEnableCommandMode]
        self.config_mode = modes[L1SSHTestConfigCommandMode]
...
# c = L1SSHTestCliConnection(get_qs_logger(), 'tl1', '10.99.99.230', 3082, 'root', 'root', 1)
