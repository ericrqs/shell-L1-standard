...
# from clitest2_tl1_connection import Clitest2TL1Connection
# from clitest2_cli_connection import Clitest2CliConnection

class Clitest2L1Handler(L1HandlerBase):
    ...
    def __init__(self, logger):
        ...
        try:
            with open(os.path.join(os.path.dirname(sys.argv[0]), 'clitest2_runtime_configuration.json')) as f:
                o = json.loads(f.read())
    ...
    def login(self, address, username, password):
        ...
        # self._tl1_connection = Clitest2TL1Connection(self._host, self._port, self._username, self._password, self._logger)
        # self._cli_connection = Clitest2CliConnection(self._host, self._port, self._username, self._password, self._logger)
    ...
    def get_resource_description(self, address):
        ...
        SWITCH_MODEL = 'Clitest2'
        BLADE_PREFIX = 'module'
        BLADE_FAMILY = 'L1 Switch Blade'
        BLADE_MODEL = 'Clitest2 Blade'
        PORT_PREFIX = 'port'
        PORT_FAMILY = 'L1 Switch Port'
        PORT_MODEL = 'Clitest2 Port'
